...
public class DatabaseProvider {
	...
	void connect() {
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3333/virtusa_first_project", "root",
					"Kesava@2021");
	...
	public void employeestore(String name, String phone, String email, String password, String companyName,
		...
		String employeestore = "insert into virtusa_first_project.employee values(?,?,?,?,?,?,?,?)";
		connect();
	...
	public void jobseekerStore(String name, String password, String email, String phone, String experience, String city,
		...
		String jobseekerstore = "insert into virtusa_first_project.jobseeker values(?,?,?,?,?,?,?)";
		connect();
	...
	public void jobstore(String companyName, String jobTitle, String language, String employment, String jobDescription,
		...
		String jobstore = "insert into virtusa_first_project.jobs values(?,?,?,?,?,?,?,?)";
		connect();
	...
	public void jobApplicantStore(JobSeeker js, String jobid) throws SQLException {
		String jobApplicantStore = "insert into virtusa_first_project.jobApplicants values(?,?,?,?,?,?,?,?)";
		connect();
	...
	public void employeretrive() throws SQLException {
		String empretrive = "select * from virtusa_first_project.employee";
		connect();
	...
	public void jobseekerretrive() throws SQLException {
		String jobskretrive = "select * from virtusa_first_project.jobseeker";
		connect();
	...
	public void jobretrive() throws SQLException {
		String jobretrive = "select * from virtusa_first_project.jobs";
		connect();
	...
	public void jobApplicantretrive() throws SQLException {
		String jobapplicantretrive = "select * from virtusa_first_project.jobApplicants";
		connect();
